# 照片分类 (PhotoClassifier)

一款轻量级的 macOS 原生照片/视频分类整理工具。通过文件夹目录结构管理标签，支持全屏沉浸式打标，帮助你快速整理大量照片和视频文件。
...
| 网格浏览 | 分类整理 | 沉浸打标 |
|:---:|:---:|:---:|
| ![网格浏览模式](docs/images/use-01.png) | ![分类整理效果](docs/images/use-02.png) | ![沉浸式打标](docs/images/use-03.png) |
